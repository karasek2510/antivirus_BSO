...
#include <yara.h>
#include <string>
#include "../../include/yaracpp/yaracpp.h"
#include "../../include/yaracpp/yara_detector/yara_detector.h"
#include "../../include/yaracpp/types/yara_rule.h"
#include "../../include/yaracpp/types/yara_meta.h"
#include "../../include/yaracpp/types/yara_match.h"
 ...
 */
        ...
        struct Scanner<std::string> {
            static bool scan(YR_RULES *rules, YR_CALLBACK_FUNC callback, YaraDetector::CallbackSettings &settings,
 ...
 */
        ...
        struct Scanner<std::vector<std::uint8_t>> {
            static bool scan(YR_RULES *rules, YR_CALLBACK_FUNC callback, YaraDetector::CallbackSettings &settings,
                ...
                return yr_rules_scan_mem(rules, const_cast<uint8_t *>(buffer.data()), buffer.size(), 0, callback,
                                         &settings, 0) == ERROR_SUCCESS;
            }
        };
 ...
 */
    YaraDetector::YaraDetector() : compiler(nullptr), files(), detectedRules(), undetectedRules(),
                                   textFilesRules(nullptr),
 ...
 */
    YaraDetector::CallbackSettings::CallbackSettings(bool cStoreAll, std::vector<YaraRule> &cDetected,
